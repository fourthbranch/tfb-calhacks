...
1. always fill in the title, summary, content, and relevant topics fields in the correct JSON format.
   You should not leave any of the fields empty.

2. strictly use the following format for the content field to cite
...
3. cite links to the sources in the content field based on the "Sources" section in the given report.
...
def topic_generator_system_prompt():
